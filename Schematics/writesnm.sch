...
C {code.sym} -480 -210 0 0 {name=Writesnm only_toplevel=false value=".lib /usr/local/share/pdk/sky130A/libs.tech/ngspice/sky130.lib.spice tt
.param temp=27
.param supl=1.8
...
wrdata /home/scholes33/Projects/PreLayout/Xschem/writesnm.txt q1 qb1 q2 qb2
.endc
.end
"
}
...
C {gnd.sym} -20 210 0 0 {name=l6 lab=GND}
C {lab_wire.sym} 40 210 2 0 {name=p12 sig_type=std_logic lab=VCC}
