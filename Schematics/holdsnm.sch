...
N -50 50 -50 110 {lab=VCC}
N -50 130 -20 130 {lab=VCC}
N 70 50 70 130 {lab=VCC}
N 40 130 70 130 {lab=VCC}
N -50 110 -50 130 {lab=VCC}
...
C {code.sym} -480 -210 0 0 {name=Holdsnm only_toplevel=false value=".lib /usr/local/share/pdk/sky130A/libs.tech/ngspice/sky130.lib.spice tt
.param temp=27
.param supl=1.8
